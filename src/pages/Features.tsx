            ...
            <div className="mb-24">
              <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
                ...
                <div className="md:w-1/2">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="h-8 w-1 bg-varna-accent-teal rounded-full"></div>
                    <h2 className="text-3xl font-bold">Grammar Correction</h2>
                  </div>
                  <p className="text-muted-foreground mb-6">
                    Perfect your language skills with our advanced grammar correction tool. Our AI analyzes your writing in real-time, providing instant feedback and suggestions to help you write with confidence.
                  </p>
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-center gap-2">
                      <div className="rounded-full bg-varna-accent-teal/10 p-1">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <span>Context-aware corrections with explanations</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="rounded-full bg-varna-accent-teal/10 p-1">
                        <Sparkles className="h-4 w-4 text-varna-accent-teal" />
                      </div>
                      <span>Advanced writing style improvements</span>
                    </li>
                  </ul>
                  <Button className="bg-gradient-to-r from-varna-accent-teal to-varna-purple hover:opacity-90 transition-opacity" asChild>
                    <Link to="/grammar">Try Grammar Assistant</Link>
                  </Button>
                </div>
              </div>
            </div>
